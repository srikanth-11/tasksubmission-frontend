    ...
    <Headroom>
      <header className="header">
        <a href="#" className="logo">
          ...
          <span className="logo-name">Tasksubmission</span>
          <span className="grey-color"></span>
        </a>
          ...
          <div className="greeting-text-div">
            <div>
              <h1 className="greeting-text" id="type">
                ...
                <span>welcome to Tasksubmission</span>

                {" "}

              </h1>
              <p className="greeting-text-p subTitle">you can submit tasks through our platform</p>
